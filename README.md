...
- **真實視大小 / True apparent sizes** — 地平視角的日月行星預設是「示意」尺寸（太陽約 3.3°、行星約 1.4°，
  遠比真實大，這樣才看得見）。勾選「日月行星真實視大小」改用真實角徑 2·atan(R/d)：太陽與月亮各約 0.5°、
  彼此大小相當，行星則縮成幾乎只剩亮點（保留約 1.2 像素的下限，否則整顆消失）。
